    ...
    public class Antivenin
    {
        ...
        public static bool StackWalk(uint ProcessId, uint ThreadId)
        {
            ...
            for (int frameNum = 0; ; frameNum++)
            {
                ...
                Symbol.MaxNameLength = Constants.MAX_NAMELEN;
                ...
                DbgHelp.SymGetSymFromAddr64(hProcess, StackFrame.AddrPC.Offset, Offset, lpSymbol);
                Symbol = (IMAGEHLP_SYMBOL64)Marshal.PtrToStructure(lpSymbol, typeof(IMAGEHLP_SYMBOL64));
                Console.WriteLine("0x" + StackFrame.AddrReturn.Offset.ToString("X8") + "\t" + (new string(Symbol.Name)) + "\t" + lpFilename.ToString());
