function Initialize-PowerWalker {
<#
.SYNOPSIS

Loads Win32 interop requirements for walking thread stacks.
...
#>
    ...
    $FunctionDefinitions = @(
        ...
        (func Kernel32 GetNativeSystemInfo ([Void]) @([SYSTEM_INFO].MakeByRefType())),
        ...
        (func Dbghelp SymGetSymFromAddr64 ([Bool]) @([IntPtr], [UInt64], [UIntPtr], [IntPtr]) -SetLastError),
    ...
    $null = $FunctionDefinitions | Add-Win32Type -Module $Mod -Namespace 'Win32'    
}